package org.example.hw.homework5;
...
public class Philosopher extends Thread {
    ...
    private org.example.hw.homework5.Table table;

    public Philosopher(String name, org.example.hw.homework5.Table table, int leftFork, int rightFork, CountDownLatch cdl) {
        this.table = table;
        this.name = name;
